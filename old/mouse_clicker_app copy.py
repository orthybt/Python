...
# Variables to keep track of hotkeys
hotkey_tor_plus = None
hotkey_tor_minus = None
...
def register_hotkeys():
    global hotkey_tor_plus, hotkey_tor_minus
    if not hotkey_tor_plus and not hotkey_tor_minus:
        hotkey_tor_plus = keyboard.add_hotkey('1', lambda: perform_click('Tor+'))
        hotkey_tor_minus = keyboard.add_hotkey('2', lambda: perform_click('Tor-'))
        print("Hotkeys registered")

def unregister_hotkeys():
    global hotkey_tor_plus, hotkey_tor_minus
    if hotkey_tor_plus:
        keyboard.remove_hotkey(hotkey_tor_plus)
        hotkey_tor_plus = None
    if hotkey_tor_minus:
        keyboard.remove_hotkey(hotkey_tor_minus)
        hotkey_tor_minus = None
